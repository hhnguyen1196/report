...
const Button = ({children, onClick, type, buttonType = "button"}: Props) => {
  const insertReport = "rounded-md px-4 py-2 text-white bg-red-600 hover:bg-red-500";
  ...
  const exportExcel = "rounded-md mt-4 px-4 py-2 border-solid border border-red-600 bg-white-400 text-red-500";
  const importExcel = "rounded-md mx-3 mt-4 px-4 py-2 border-solid border border-red-600 bg-white-400 text-red-500";
  const styles: Styles = {
